# StepFun Degerlendirici — Tam Sistem Promptu
...
## Teknik Not (31 Mayıs 2026)
- StepFun reasoning modeldir — basit prompt'ta boş döner
- 5 konuşma + bu prompt ile değerlendirme için **max_tokens=8000** gerekir
- 4000 token altında reasoning tüm token'ları tüketir, içerik üretmez
- Cron script: `~/.hermes/scripts/stepfun_evaluator.py` (no_agent=true)
