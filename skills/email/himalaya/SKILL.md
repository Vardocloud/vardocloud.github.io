...
- **App Password boşluklar:** Google App Password 16 haneli, 4'lü gruplar halinde gösterilir. Boşluklu veya boşluksuz yazılabilir (her ikisi de çalışır). Doğrudan `echo -n "xxxx yyyy zzzz tttt"` ile password dosyasına yaz.
