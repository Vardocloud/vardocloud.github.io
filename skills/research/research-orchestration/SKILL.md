...
See `references/platform-blueprint-marketplace-research.md` for evaluating technology platform blueprint/solution marketplaces (NVIDIA Blueprints, AWS Solutions, etc.) — SPA pagination handling, detail-page URL construction, tiered prioritization, and action-plan generation workflows.
