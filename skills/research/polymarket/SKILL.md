...
> Debug ipucu: Polymarket’te **HTTP 400** için “Gamma/CLOB hızlı triage” notu: `references/400-bad-request-triage.md`.

> Not: Bu skill ayrıca Polymarket’i **AI ile entegre ama trade’lemeyen** “sinyal/analiz” kullanımları için pratik bir playbook içerir.
> Bkz: `references/usage-playbook-for-simpler-ai-integration.md`.

> **M-W-F cron job:** `references/news-driven-trading-workflow.md` — Polymarket haber sinyal taraması + kurallı trade kararları. Cron ortamında (kullanıcı yok) tam otomatik çalışır.
...
- This skill is read-only — it does not support placing trades.
  ...
  **News-driven trading decisions (cron job):** `references/news-driven-trading-workflow.md`.
